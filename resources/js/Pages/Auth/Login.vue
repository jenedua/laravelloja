...
//   try {
//     const response = await fetch('/auth/google/redirect'); // Fetch the redirect URL
//     if (!response.ok) {
//       // Handle errors (e.g., display an error message)
//       console.error('Error fetching Google redirect URL:', response.statusText);
//       return;
//     }
//     const redirectUrl = await response.text(); // Extract the redirect URL from the response
